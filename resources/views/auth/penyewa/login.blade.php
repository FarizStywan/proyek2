...
<body class="bg-white flex items-center justify-center min-h-screen relative font-sans">
    ...
    <div class="relative flex items-center justify-between w-10/12 max-w-5xl">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl w-96 text-center">
            ...
            <!-- Notifikasi Error -->
            @if ($errors->any())
                <div class="bg-red-500 text-white p-3 rounded-lg mb-4 text-left">
            ...
            <form action="{{ route('penyewa.login.submit') }}" method="POST" class="space-y-4">
                @csrf
            ...
            <!-- Link ke Register -->
            <p class="mt-4 text-gray-600">Belum punya akun? 
                <a href="{{ route('penyewa.register') }}" class="text-[#5790AB] font-semibold hover:underline">Daftar</a>
            </p>
        </div>
